...
import { CartItem, cleanupAfterAggregationTesting, ExpectedRoom, Order, prepareAggregationTesting, Product, Room, User } from "../utils";
...
afterAll(async () => {
    await cleanupAfterAggregationTesting(redis);
});
